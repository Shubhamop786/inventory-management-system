...
export default function InsertProduct() {
  ...
  const addProduct = async (e) => {
    ...
    try {
      const res = await fetch('https://inventory-backend-x29y.onrender.com/insertproduct', {
        method: 'POST',
        headers: {
    ...
    <div className="container-fluid p-5">
      ...
      <div className="mt-3 mb-5 col-lg-6 col-md-6 col-12 fs-4">
        ...
        <input
          ...
          className="form-control fs-5"
          id="product_barcode"
          placeholder="Enter Product Barcode (Max 12 digits)"
          maxLength={12}
          required
        />
      </div>
      ...
      <div className="d-flex justify-content-center col-lg-6 col-md-6">
        <NavLink to="/products" className="btn btn-secondary me-4 fs-4">Cancel</NavLink>
        <button
          type="submit"
          onClick={addProduct}
